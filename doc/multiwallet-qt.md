...
In order to support loading of multiple wallets in cmos-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cmos.cpp.
...
Changes to cmos.cpp
----------------------
cmos.cpp is the entry point into cmos-qt, and as such, will require some minor modifications to provide hooks for
