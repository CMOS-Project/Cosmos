Contributing to Cosmos Core
============================

The Cosmos Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Cosmos Core project, and is not to be
confused with overall CMOS Network Protocol consensus changes.

Whether a pull request is merged into Cosmos Core rests with the project merge
...
Patches that change CMOS consensus rules are considerably more involved than
...
Where a patch set proposes to change the CMOS consensus, it must have been
...
The project leader is the release manager for each Cosmos Core release.
