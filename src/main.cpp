...
#if defined(NDEBUG)
#error "CMOS cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight, CAmount nFees, bool fBudgetBlock)
{
    ...
    if (nHeight == 1)
        nSubsidy = CAmount(6000000) * COIN; //premine has no budget allocation
    else if (nHeight < 43200) // day 1 to 30 
        nSubsidy = 20 * nBudgetMultiplier;
    else if (nHeight < 86400) // day 31 to 60
        nSubsidy = 15 * nBudgetMultiplier;
    else if (nHeight < 172800) // day 61 to 120
