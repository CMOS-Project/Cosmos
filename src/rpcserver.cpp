...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Cosmos features */
        {"cmos", "masternode", &masternode, true, true, false},
        {"cmos", "masternodelist", &masternodelist, true, true, false},
        {"cmos", "mnbudget", &mnbudget, true, true, false},
        {"cmos", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"cmos", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"cmos", "mnsync", &mnsync, true, true, false},
        {"cmos", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"cmos", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use cmosd, or the -server option to cmos-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> cmos-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:61145/\n";
}
