...
/** Utility functions used by the Cosmos Qt UI.
 */
namespace GUIUtil
{
...
// Render Cosmos addresses in monospace font
...
// Parse "cmos:" URI into recipient object, return true on successful parsing
