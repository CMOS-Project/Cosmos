...
RESOURCES += src/qt/cmos.qrc src/qt/cmos_locale.qrc

TRANSLATIONS += src/qt/locale/cmos_bg.ts \
                src/qt/locale/cmos_de.ts \
                src/qt/locale/cmos_en.ts \
                src/qt/locale/cmos_es.ts \
                src/qt/locale/cmos_fi.ts \
                src/qt/locale/cmos_fr.ts \
                src/qt/locale/cmos_it.ts \
                src/qt/locale/cmos_ja.ts \
                src/qt/locale/cmos_pl.ts \
                src/qt/locale/cmos_pt.ts \
                src/qt/locale/cmos_ru.ts \
                src/qt/locale/cmos_sk.ts \
                src/qt/locale/cmos_sv.ts \
                src/qt/locale/cmos_vi.ts \
                src/qt/locale/cmos_zh_CN.ts \
                src/qt/locale/cmos_zh_TW.ts
